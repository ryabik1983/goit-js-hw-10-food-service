...
exports.default = createMenuCardsMarkup;
...
function createMenuCardsMarkup(items) {
  return items.map(function (_ref) {
    ...
    return "\n<li class=\"menu__item\">\n  <article class=\"card\">\n    <img\n      src=\"".concat(image, "\"\n      alt=\"").concat(description, "\"\n      class=\"card__image\"\n    />\n    <div class=\"card__content\">\n      <h2 class=\"card__name\">").concat(name, "</h2>\n      <p class=\"card__price\">\n        <i class=\"material-icons\"> monetization_on </i>\n        ").concat(price, " \u043A\u0440\u0435\u0434\u0438\u0442\u043E\u0432\n      </p>\n\n      <p class=\"card__descr\">\n        ").concat(description, "\n        </p>\n\n      <ul class=\"tag-list\">\n        <li class=\"tag-list__item\">").concat(ingredients[0], "</li>\n        <li class=\"tag-list__item\">").concat(ingredients[1], "</li>\n        <li class=\"tag-list__item\">").concat(ingredients[2], "</li>\n        <li class=\"tag-list__item\">").concat(ingredients[3], "</li>\n        <li class=\"tag-list__item\">").concat(ingredients[4], "</li>\n        <li class=\"tag-list__item\">").concat(ingredients[5], "</li>\n        <li class=\"tag-list__item\">").concat(ingredients[6], "</li>\n      </ul>\n    </div>\n\n    <button class=\"card__button button\">\n      <i class=\"material-icons button__icon\"> shopping_cart </i>\n      \u0412 \u043A\u043E\u0440\u0437\u0438\u043D\u0443\n    </button>\n  </article>\n</li>\n");
  }).join('');
}
...
console.log(refs);
var menuMarkup = (0, _createMarkup.default)(_menu.default);
refs.menuList.insertAdjacentHTML('beforeend', menuMarkup);
console.log(refs.menuList);
},{"./menu.json":"menu.json","./js/createMarkup":"js/createMarkup.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
